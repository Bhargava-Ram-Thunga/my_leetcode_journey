...
1570 - Final Prices With a Special Discount in a ShopDifficulty: Easy - final-prices-with-a-special-discount-in-a-shopYou are given an integer array `prices` where `prices[i]` is the price of the `i^th` item in a shop.
