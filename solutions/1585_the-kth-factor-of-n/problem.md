...
1585 - The kth Factor of nDifficulty: Medium - the-kth-factor-of-nYou are given two positive integers `n` and `k`. A factor of an integer `n` is defined as an integer `i` where `n % i == 0`.
