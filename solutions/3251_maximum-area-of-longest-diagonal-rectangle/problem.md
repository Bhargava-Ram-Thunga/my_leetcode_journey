...
3251 - Maximum Area of Longest Diagonal RectangleDifficulty: Easy - maximum-area-of-longest-diagonal-rectangleYou are given a 2D **0-indexed **integer array `dimensions`.
