...
2163 - Kth Distinct String in an ArrayDifficulty: Easy - kth-distinct-string-in-an-arrayA **distinct string** is a string that is present only **once** in an array.
