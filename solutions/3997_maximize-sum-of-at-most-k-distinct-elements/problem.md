...
3997 - Maximize Sum of At Most K Distinct ElementsDifficulty: Easy - maximize-sum-of-at-most-k-distinct-elementsYou are given a **positive** integer array `nums` and an integer `k`.
