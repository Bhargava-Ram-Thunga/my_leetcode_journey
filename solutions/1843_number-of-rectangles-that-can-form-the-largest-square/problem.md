...
1843 - Number Of Rectangles That Can Form The Largest SquareDifficulty: Easy - number-of-rectangles-that-can-form-the-largest-squareYou are given an array `rectangles` where `rectangles[i] = [li, wi]` represents the `i^th` rectangle of length `li` and width `wi`.
