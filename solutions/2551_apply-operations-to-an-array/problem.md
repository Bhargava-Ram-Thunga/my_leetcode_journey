...
2551 - Apply Operations to an ArrayDifficulty: Easy - apply-operations-to-an-arrayYou are given a **0-indexed** array `nums` of size `n` consisting of **non-negative** integers.
