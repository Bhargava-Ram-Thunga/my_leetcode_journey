...
2021 - Remove All Occurrences of a SubstringDifficulty: Medium - remove-all-occurrences-of-a-substringGiven two strings `s` and `part`, perform the following operation on `s` until **all** occurrences of the substring `part` are removed:
