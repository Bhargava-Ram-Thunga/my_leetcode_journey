...
3320 - Maximum Number of Operations With the Same Score IDifficulty: Easy - maximum-number-of-operations-with-the-same-score-iYou are given an array of integers `nums`. Consider the following operation:
