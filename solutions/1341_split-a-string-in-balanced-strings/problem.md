...
1341 - Split a String in Balanced StringsDifficulty: Easy - split-a-string-in-balanced-strings**Balanced** strings are those that have an equal quantity of `'L'` and `'R'` characters.
