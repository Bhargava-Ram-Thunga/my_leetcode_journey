...
3567 - Convert Date to BinaryDifficulty: Easy - convert-date-to-binaryYou are given a string `date` representing a Gregorian calendar date in the `yyyy-mm-dd` format.
